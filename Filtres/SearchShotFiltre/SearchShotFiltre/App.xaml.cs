...
using SearchShotFiltre.Helpers;
using SearchShotFiltre.Models;
using SearchShotFiltre.Resources;

namespace SearchShotFiltre
{
    public partial class App : Application
    {
        ...
        public static FiltersModel FilterModel { get; private set; }
        public static PhotoModel PhotoModel { get; set; }
        public static StreamRenderingHelper PhotoStreamHelper { get; private set; }
        /// <summary>
        ...
        public App()
        {
			...
			PhotoStreamHelper = new StreamRenderingHelper();
        }
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
		            if (!e.IsApplicationInstancePreserved)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Erreur lors de la restauration: " + ex.Message);
                }
            }
        }
