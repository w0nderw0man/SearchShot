...
using SearchShot.Pages;
using SearchShot.Helpers;
using SearchShot.Converters;

namespace SearchShot.Helpers
{
    /// <summary>
    ...
    public class StreamRenderingHelper : INotifyPropertyChanged
    {
        ...
        private void EnsureProcessing()
        {
            ...
            System.Diagnostics.Debug.WriteLine("En cours " + _processingNow);
        }
        ...
        private async void Process()
        {
            ...
            while (_enabled && Count > 0)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Erreur de stream :" + ex.Message);
