...
namespace WS
{
    ...
    public interface IService1
    {
      ...
      /*  [OperationContract]
        ...
        /// <returns></returns>
        [OperationContract]
        int Inscription(string password, string login, int level, int score, int connexion, Image picture,
        ...
        /// <returns></returns> */
        [OperationContract]
        bool Authentification(string login, string mail, string password);
        /*
        /// <summary>
